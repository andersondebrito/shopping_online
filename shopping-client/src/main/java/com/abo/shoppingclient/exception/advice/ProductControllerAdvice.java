package com.abo.shoppingclient.exception.advice;

import com.abo.shoppingclient.dto.ErrorDTO;
import com.abo.shoppingclient.exception.CategoryNotFoundException;
import com.abo.shoppingclient.exception.ProductNotFoundException;
...
@ControllerAdvice(
        basePackages = "com.abo.controller")
public class ProductControllerAdvice {
    ...
    public ErrorDTO processValidationError(
        ...
        StringBuilder sb =
                new StringBuilder("Invalid value for field(s):");
